function CalcRevenues3(){
	...
	if (sbusinessunit == "Benchmark") {
		...
		if (val2 == null || value == "") {
			...
			val2 = 0;
			Xrm.Page.data.entity.attributes.get("new_bdp").setValue(val2); 
			}
		var val3 = Xrm.Page.data.entity.attributes.get("new_premiumbdp").getValue();
		if (val3 == null || value == "") {
			
			val3 = 0;
			Xrm.Page.data.entity.attributes.get("new_premiumbdp").setValue(val3); 
			}
		var val4 = Xrm.Page.data.entity.attributes.get("new_benchmarksupport").getValue();
		if (val4 == null || value == "") {
			
			val4 = 0;
			Xrm.Page.data.entity.attributes.get("new_benchmarksupport").setValue(val4); 
			}
		...
		if (val2 == null || value == "") {
			...
			val2 = 0;
			Xrm.Page.data.entity.attributes.get("new_kanzisupport").setValue(val2); 
			}
		var val3 = Xrm.Page.data.entity.attributes.get("new_kanzinre").getValue();
		if (val3 == null || value == "") {
			
			val3 = 0;
			Xrm.Page.data.entity.attributes.get("new_kanzinre").setValue(val3); 
			}
		var val4 = Xrm.Page.data.entity.attributes.get("new_kanziroyalty").getValue();
		if (val4 == null || value == "") {
			
			val4 = 0;
			Xrm.Page.data.entity.attributes.get("new_kanziroyalty").setValue(val4); 
			}
		var val5 = Xrm.Page.data.entity.attributes.get("new_kanzitraining").getValue();
		if (val5 == null || value == "") {
			
			val5 = 0;
			Xrm.Page.data.entity.attributes.get("new_kanzitraining").setValue(val5); 
			}
